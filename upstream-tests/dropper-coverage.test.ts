...
describe("V3 dropper reflection coverage helpers", () => {
  ...
  it("summarizes coverage counts and token totals by relevance", () => {
    const observations = [
      observation("aaaaaaaaaaaa", { relevance: "low", content: "x".repeat(12), tokenCount: 999 }),
      observation("bbbbbbbbbbbb", { relevance: "critical", content: "x".repeat(20), tokenCount: 0 }),
      observation("cccccccccccc", { relevance: "critical", content: "x".repeat(28), tokenCount: 1 }),
    ];
  ...
  it("summarizes coverage transitions by relevance without exposing ids", () => {
    const observations = [
      observation("aaaaaaaaaaaa", { relevance: "high", content: "x".repeat(12), tokenCount: 999 }),
      observation("bbbbbbbbbbbb", { relevance: "critical", content: "x".repeat(20), tokenCount: 0 }),
      observation("cccccccccccc", { relevance: "critical", content: "x".repeat(28), tokenCount: 1 }),
    ];
